...
export default new Router({
  routes: [
      ...
      children: [
        {
          ...
          path: '/user/add',
          component: userAdd,
          meta: {model: 'User', parent: '/user/list'},
        },
        {
          name: 'user_edit',
      ...
      children: [
        {
          ...
          meta: {model: 'System', parent: '/system/auth_group/list'},
        },
        {
      ...
      children: [
        {
          ...
          meta: {model: 'System', parent: '/system/menu_model/list'},
        },
        {
      ...
      children: [
        {
          ...
          meta: {model: 'System', parent: '/system/auth_menu/list'},
        },
        {
          name: 'auth_menu_edit',
      ...
      children: [
        {
          ...
          meta: {model: 'System', parent: '/system/auth_rule/list'},
        },
        {
          name: 'auth_rule_edit',
      ...
      children: [
        {
          ...
          path: '/team/add',
          component: TeamAdd,
          meta: {model: 'Team', parent: '/team/list'},
        },
        {
          name: 'team_edit',
    ...
    },
    {
      ...
      meta: {model: 'Team', parent: '/team/user/level/list'},
    },
    {
    ...
    },
    {
      ...
      meta: {model: 'Team', parent: '/team/user/position/list'},
    },
    {
