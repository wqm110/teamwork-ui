<template>
    <div>
        <wrapper-content pageTitle="所有项目">
            <div class="data-content">
                <div class="table-edit">
                    <div class="left-actions">
                        <Button permission="Project_Project.addProject"
                    ...
                    <div class="right-actions">
                        <ButtonGroup class="select m-r-xs">
                            ...
                            <Button shape="circle" type="ghost" :class="{'active' : project_state == 0}"
                                    @click="project_state = 0">未安排
                            </Button>
                ...
                <Page v-if="teamCount > 0" :total="teamCount" :page-size="page_size" :current="page_num"
...
<script>
    ...
    export default {
        ...
        methods: {
            getList() {
                let app = this;
                if (app.project_state === -1) {
                    app.loading = true
                }
                getList(app.project_state, app.page_size, app.page_num, app.keyword).then(res => {
                    app.loading = false;
