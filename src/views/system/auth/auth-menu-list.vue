            ...
            <div class="data-content">
                <div class="table-edit">
                    <div class="left-actions">
                        <router-link permission="System_AuthMenu.addMenu" :to="'/system/auth_menu/add?pid='+pid">
                ...
                <Table border :columns="columns" :data="group_list" @on-selection-change="selectItem"
